...
import 'package:sugar_cubes/screens/auth/register_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  logIn() async {
    if (formKey.currentState!.validate()) {
      ...
      await authService.logInWithEmailPassword(email, password).then((value) async  {
        if (value == true) {
